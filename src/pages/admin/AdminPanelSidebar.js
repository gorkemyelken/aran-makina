...
import { Dashboard, ExpandLess, ExpandMore, Person, Store, AddCircle, List as ListIcon, Build } from '@mui/icons-material';
...
const AdminPanelSidebar = () => {
  ...
  return (
    <Box sx={{ width: '250px', backgroundColor: '#014DAD', color: 'white', minHeight: '100vh' }}>
      <List>
        {/* Dashboard */}
        ...
        <Collapse in={openProducts} timeout="auto" unmountOnExit>
          <List component="div" disablePadding>
            ...
            <ListItem button component={Link} to="/admin/products/add">
              ...
              <ListItemText primary="Ürün Ekle" sx={{ pl: 2, color: 'white' }} />
            </ListItem>
            ...
            <ListItem button component={Link} to="/admin/products">
              ...
              <ListItemText primary="Ürünleri Listele" sx={{ pl: 2, color: 'white' }} />
            </ListItem>
          </List>
        </Collapse>
        ...
        <ListItem button onClick={handleFeaturesClick}>
          ...
          {openFeatures ? <ExpandLess sx={{ color: 'white' }} /> : <ExpandMore sx={{ color: 'white' }} />}
        </ListItem>
        <Collapse in={openFeatures} timeout="auto" unmountOnExit>
          <List component="div" disablePadding>
            ...
            <ListItem button component={Link} to="/admin/features">
              ...
              <ListItemText primary="Özellikleri Listele" sx={{ pl: 2, color: 'white' }} />
            </ListItem>
            ...
            <ListItem button component={Link} to="/admin/features/add">
              ...
              <ListItemText primary="Yeni Özellik Ekle" sx={{ pl: 2, color: 'white' }} />
            </ListItem>
          </List>
        </Collapse>
